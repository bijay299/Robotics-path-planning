...
class GridGraph:
    ...
    def __init__(self, file_path=None, width=-1, height=-1, origin=(0, 0),
        ...
        # Stores which cells have been visited in order for visualization.
        self.visited_cells = []

        # Dictionary to store parents for each cell: (i, j) -> Cell or None.
        # This is used by trace_path() to rebuild the path.
        self.parent = {}
    ...
    def init_graph(self):
        ...
        # Clear visited list for visualization.
        self.visited_cells = []

        # Clear all parents. Each search will fill this in.
        self.parent = {}

    def find_neighbors(self, i, j):
        """Returns a list of the neighbors of the given cell as Cell objects.
        Neighbor cells must be inside the map bounds and not in collision."""
        neighbors = []

        # 4-connected grid: right, left, down, up
        directions = [
            (1, 0),   # right
            (-1, 0),  # left
            (0, 1),   # down
        ...
        for di, dj in directions:
            ...
            # Skip if robot would collide here
